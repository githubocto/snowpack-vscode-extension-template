    ...
    <FieldWithDescription title={props.title}>
      <div className="flex flex-col space-y-2">
        ...
        <div className="flex flex-row flex-wrap items-center">
          <input
            className="flex-1 p-1 h-8 text-sm bg-vscode-input-background border-vscode-input-border text-vscode-input-foreground placeholder-vscode-input-placeholderForeground focus:border-vscode-inputOption-activeBorder"
            id={id}
